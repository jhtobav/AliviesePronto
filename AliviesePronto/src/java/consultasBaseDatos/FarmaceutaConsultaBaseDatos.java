...
public class FarmaceutaConsultaBaseDatos {
    ...
    public List<Farmaceuta> obtenerFarmaceutas(){
        ...
        List<Farmaceuta> farmaceutas = null;

        try {
            q = em.createNamedQuery("Farmaceuta.findAll", Farmaceuta.class);
            farmaceutas = q.getResultList();
        } catch (Exception e) {
